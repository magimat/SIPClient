...
public class CustomConfig implements Config {
    ...
    public InetAddress getLocalInetAddress() {
        ...
        try {
            ...
            //inetAddress = InetAddress.getByName("192.168.11.102");
            inetAddress = InetAddress.getByName("192.168.11.222");
    ...
    @Override public String getDomain() { return "montreal4.voip.ms"; }
